export function Hero() {
  return (
    <section id="inicio" className="relative min-h-[100svh] flex flex-col items-center justify-center bg-teal overflow-hidden pt-28 pb-16 md:pt-20 md:pb-12">
      
      {/* Subtle Background Pattern */}
      <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: 'radial-gradient(var(--color-cream) 0.5px, transparent 0.5px)', backgroundSize: '30px 30px' }}></div>
