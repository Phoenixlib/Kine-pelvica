        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 justify-between">
          ...
          <div className="flex flex-col items-start lg:col-span-1">
             ...
             <div className="flex gap-4">
               <a href="#" className="text-[#f7f3ef]/60 hover:text-terracotta transition-colors" aria-label="Instagram">
               ...
               <a href="#" className="text-[#f7f3ef]/60 hover:text-terracotta transition-colors" aria-label="Facebook">
                 <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
          ...
          <div>
             ...
             <ul className="space-y-4 font-body text-sm text-[#f7f3ef]/80">
                <li className="flex gap-3 items-start group cursor-default">
                   ...
                   <span className="leading-snug">Benigno Posadas 1884<br/>Iquique, Chile</span>
                </li>
