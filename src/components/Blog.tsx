    ...
    <section id="blog" className="py-24 bg-offwhite">
      <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div>
            <h2 className="text-[11px] font-subtitle font-bold tracking-[0.2em] text-redbrown uppercase mb-4">
              Blog
            </h2>
            <h3 className="font-title text-4xl md:text-5xl text-teal">
              <span className="italic font-light text-terracotta">Últimas</span>{" "}
              Publicaciones
            </h3>
          </div>
          <Link
            href="/blog"
            className="font-subtitle text-[11px] uppercase tracking-widest font-bold text-teal hover:text-terracotta border-b border-teal hover:border-terracotta transition-colors pb-1 flex-shrink-0"
          >
            ...
            return (
              ...
              >
                ...
                <div className="p-8 md:p-10 flex-1 flex flex-col">
                  {post.category && (
                    <span className="text-[10px] uppercase tracking-[0.2em] font-subtitle font-bold text-dustypink mb-4 block">
                      {post.category}
                    </span>
                  )}
